 ...
 * single MoveGenerator instance every seat's AIPlayer shares, e.g. {avoidMapIdFromRound:{...}} --
 * used by "LV3" until that policy was removed 2026-08-28 (see MoveGenerator's own doc). Left
